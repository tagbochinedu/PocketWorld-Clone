    ...
    <section className="bg-primary py-[140px] text-white overflow-hidden lg:mb-[100vh]">
      <div className="mx-auto max-w-[1340px] px-7 lg:px-10">
        <div className="lg:pl-[110px] relative pb-20">
          <Image src={puzzle} alt="" className="absolute right-0 -top-10 z-10 lg:z-20" />
          <p className="text-[32px] leading-10 font-bold max-w-[790px] font-gt relative z-20 lg:z-10">
            Our team has a{" "}
      ...
      <div className="bg-secondary py-[70px] relative rounded-l-full left-[5%]">
        <div className="px-20 lg:px-[180px]">
          <h4 className="text-[64px] font-black mb-10 font-gt leading-[72px] max-w-4xl">
          ...
          <a
            ...
            className=""
          >
            <button className="w-full md:w-56 rounded-full bg-primary py-3 text-base font-bold font-gt hover:shadow-joblist relative top-[0px] left-[0px] hover:shadow-joblist hover:top-[5px] hover:left-[5px] hover:text-secondary transition-all ease-linear duration-[250ms]">
              View open positions
            </button>{" "}
          </a>
        </div>
