...
const Venture = ({scrolled}: Props) => {
  return (
    <SectionWrapper
      sectionClass={`bg-primary ${scrolled < 1350 ? "hidden" : "block"}`}
    ...
    >
      ...
      <div className='text-[#f1f8ff] bg-secondary h-[560px] rounded-[40px] bg-[url("https://assets.website-files.com/616d6bd0f145779c3a8a92eb/616e95ffb75313b8200b4038_everskiesbg.png")] bg-cover px-[60px] py-[30px] mt-24 flex justify-center flex-col relative z-20'>
        <div className="">
