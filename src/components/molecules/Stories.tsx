...
const Stories = () => {
  ...
  return (
    <section className={` relative ${char ? "block" : "hidden"}`}>
      <div className="bg-secondary pb-28">
        <div className="mx-auto max-w-[1340px] px-7 lg:px-10">
          <div className="md:flex flex-wrap justify-evenly">
            <div className="md:w-5/12 lg:w-3/12 mb-10">
      ...
      <div className="bg-primary pt-28 pb-10 relative z-20">
        <div className="mx-auto max-w-[1340px] px-10 text-white relative px-7 lg:px-0">
          <div className="relative mb-20 lg:mb-28">
            <Cubesvg />
            <h3 className="text-[64px] md:text-[120px] lg:text-[160px] font-normal leading-[72px] md:leading-[100px] lg:leading-[140px] font-gt">
              Teammate <br />
              stories
            </h3>
          </div>
          <div className="lg:flex">
            <div className="w-full w-10/12 lg:w-6/12 md:flex justify-between mx-auto lg:mr-5">
              <div className="w-9/12 mx-auto md:w-4/12">
            ...
            <div className="w-full lg:w-6/12 md:flex justify-between lg:ml-5 items-center lg:relative top-[-110px]">
              <div className="w-9/12 mx-auto md:w-3/12 lg:w-4/12 mt-5 md:mt-0">
                <Image src={stor2} alt="" className="w-full" />
              </div>
              <div className="md:w-8/12 lg:w-7/12 h-fit">
                <p className="font-gt text-base font-normal leading-6 mb-7">
